#!/usr/bin/env bash
# Check NPU operators, compare complete updates, save both branches for resume.
set -eo pipefail
...
RETRACE_EXEC_NPUS="${RETRACE_EXEC_NPUS:-0,1,2,3,4,5,6,7}"
...
export ASCEND_RT_VISIBLE_DEVICES="$RETRACE_EXEC_NPUS"
export RETRACE_EXEC_NPUS
export PYTHONUNBUFFERED=1
export OMP_NUM_THREADS=1
exec "$RETRACE_PYTHON" -m speculators.models.retrace.execution_benchmark "$@"
